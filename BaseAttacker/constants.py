...
METRICS = ["distance_K", "distance_grid_K", "distance_behavior_K", "distance_W", "distance_grid_W", "distance_behavior_W", "accuracy", "accuracy_sftmx", "accuracy_sftmx_complete", "effort", "time"]
VICTIM_ALGO_KWARGS = {
